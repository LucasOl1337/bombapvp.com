# Powerup Chrono-Tesseract — candidato de power-up

## Entrega

Animação de 16 frames para um power-up geométrico: cubo cyan/dourado se abre em armações, libera quatro fragmentos orbitais e retorna ao estado compacto. O pacote permanece como `Candidato` e não foi conectado ao runtime.
...
- `preview/powerup-chrono-tesseract-preview-v2.gif` — preview em loop, 60ms por frame.
