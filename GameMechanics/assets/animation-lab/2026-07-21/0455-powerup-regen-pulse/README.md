# Powerup Regen Pulse — candidato de power-up

## Entrega

Animação de 16 frames para um power-up de regeneração: um cristal cyan/lima abre arcos em forma de folhas, forma três pétalas luminosas e retorna ao estado compacto. O pacote permanece como `Candidato` e não foi conectado ao runtime.
...
- `preview/powerup-regen-pulse-preview-v2.gif` — preview em loop, 60ms por frame.
