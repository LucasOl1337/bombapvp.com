# HUD Confirmation — candidato de feedback

Rodada do laboratorio noturno do Bomba PvP na categoria de feedback curto de HUD. O efeito desenha um anel ciano e dourado em volta do icone de chama, pulsa com ticks de confirmacao e some ao final.
...
- `preview/hud-confirmation-preview-v2.gif`: preview com 16 frames a 60 ms por frame.
