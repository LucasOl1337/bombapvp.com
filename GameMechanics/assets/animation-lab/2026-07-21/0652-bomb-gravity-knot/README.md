# Bomb Gravity Knot — candidato de VFX de bomba/explosão

Nó gravitacional angular para o Bomba PvP. Estilhaços ciano fazem uma órbita não circular ao redor do núcleo violeta, fecham um selo estelar, colapsam num ponto branco com tick âmbar e retornam ao núcleo selado.
...
- `preview/bomb-gravity-knot-preview-v2.gif`: preview em loop, 60ms por frame.
