# Collision Sparks — candidato de impacto

Rodada do laboratorio noturno do Bomba PvP na categoria de hit/impacto de colisao. O efeito e um flash branco-amarelo com raios laranja e fragmentos metalicos/ciano, adequado para contato de bomba com parede, escudo ou objeto.
...
- `preview/collision-sparks-preview-v2.gif`: preview com 16 frames a 60 ms por frame.
