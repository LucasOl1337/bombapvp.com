# Hit Kinetic Slam — candidato de hit/impacto

Impacto cinético de aterrissagem para o Bomba PvP. Um núcleo escuro desce, finca uma lâmina ciano, abre uma placa de choque baixa com estilhaços marfim, rebate em arco e termina em pequenas faíscas.
...
- `preview/hit-kinetic-slam-preview-v2.gif`: preview em loop, 60ms por frame.
