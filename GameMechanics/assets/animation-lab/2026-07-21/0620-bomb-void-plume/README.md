# Bomb Void Plume — candidato de VFX de bomba/explosão

VFX de bomba para o Bomba PvP: um núcleo preto fosco abre uma fenda violeta e projeta uma pluma de vácuo indigo com núcleo magenta, motas ciano e fechamento inward. A silhueta vertical e contida complementa os candidatos de fumaça, fusível, flare, cinder, arco, blossom e rupture.
...
- `preview/bomb-void-plume-preview-v2.gif`: preview de 16 frames a 60ms por frame.
