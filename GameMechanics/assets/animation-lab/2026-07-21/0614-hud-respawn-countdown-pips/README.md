# HUD Respawn Countdown Pips — candidato de animação curta de HUD

Feedback compacto de respawn para o Bomba PvP: quatro pips diamante acendem em sentido horário, travam em azul e o quadrado central pulsa uma vez. A composição não depende de texto ou números e evita repetir os candidatos de confirmação, streak, fuse timer, carrier crown, ability-ready e meter fill.
...
- `preview/hud-respawn-countdown-pips-preview-v2.gif`: preview de 16 frames a 60ms por frame.
