# Bomb Cinder Burst — candidato de VFX de bomba/explosão

## Entrega

Detonação curta para Bomba PvP: um núcleo branco se abre em um anel vermelho-laranja com oito cinders âmbar, atinge um burst amplo e dispersa até voltar ao ember inicial. O desenho evita fumaça, fogo volumoso e corpo da bomba, mantendo o efeito combinável com o gameplay.
...
- `preview/bomb-cinder-burst-preview-v2.gif`: preview em loop.
