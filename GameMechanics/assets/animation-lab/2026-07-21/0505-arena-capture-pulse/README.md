# Arena Capture Pulse — candidato de feedback de arena

## Entrega

Animação de 16 frames para feedback de captura: um sigilo hexagonal cyan/azul expande um anel, liga quatro marcadores cardeais, muda para lime no pico de posse e retorna ao estado compacto. O pacote permanece como `Candidato` e não foi conectado ao runtime.

## Arquivos

- `source-generated-grid.png` — fonte nativa do image_gen, 1254x1254, grade 4x4.
- `source-chromakey-removed.png` — fonte com alpha após remoção do fundo magenta.
...
- `preview/arena-capture-pulse-preview-v2.gif` — preview em loop, 60ms por frame.
