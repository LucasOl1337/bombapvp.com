# HUD Carrier Crown Ping — candidato de animação curta de HUD

## Entrega

Ping visual para identificar o portador da bomba: diamante ciano, coroa âmbar, barras laterais e pulso radial branco. O loop monta o badge, confirma rapidamente e retorna ao diamante, sem usar texto, números ou alteração de lógica de portador.
...
- `preview/hud-carrier-crown-ping-preview-v2.gif`: preview em loop.
