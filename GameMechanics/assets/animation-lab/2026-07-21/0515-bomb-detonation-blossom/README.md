# Bomb Detonation Blossom — candidato de VFX de bomba/explosão

## Entrega

Animação de 16 frames para detonação: um núcleo de bomba em grafite abre oito pétalas de chama laranja, alcança um flash branco-violeta e retorna ao núcleo em brasa. O pacote permanece como `Candidato` e não foi conectado ao runtime.
...
- `preview/bomb-detonation-blossom-preview-v2.gif` — preview em loop, 60ms por frame.
