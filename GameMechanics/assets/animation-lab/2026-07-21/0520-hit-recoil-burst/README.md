# Hit Recoil Burst — candidato de hit/impacto

## Entrega

Animação de 16 frames para um impacto frontal: diamante azul comprime o núcleo âmbar, duas placas ciano se separam, uma faixa de recuo vermelho-alaranjada marca a direção e as faíscas se dissipam antes do retorno. O pacote permanece como `Candidato` e não foi conectado ao runtime.
...
- `preview/hit-recoil-burst-preview-v2.gif` — preview em loop, 60ms por frame.
