# Hit Parry Clash — candidato de hit/impacto

## Entrega

Clash de parry para Bomba PvP: duas lâminas ciano e âmbar se aproximam, colidem em um snap circular branco com quatro fragmentos e recuam até desaparecer. O ciclo não assume personagem, arma ou regra de combate, permitindo avaliação posterior como feedback de deflexão.
...
- `preview/hit-parry-clash-preview-v2.gif`: preview em loop.
