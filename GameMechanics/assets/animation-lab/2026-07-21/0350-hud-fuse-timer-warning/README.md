# HUD Fuse Timer Warning — candidato de animação curta de HUD

## Entrega

Overlay de alerta para timer/fusível de bomba: anel segmentado âmbar, centelha ciano, chevrons de aviso e um flash branco no pico. Não há números ou texto gerados, para que o HUD possa fornecer o valor do timer separadamente. O ciclo tem 16 frames row-major e retorna ao estado inicial.
