# Hit Ground Punch — candidato de hit/impacto

## Entrega

Impacto pesado de chão para Bomba PvP: ponto de contato ciano-branco, espigão vertical âmbar, anel de energia achatado e quatro detritos angulares. O pico fica branco e a sequência cai de volta para um spark pequeno, oferecendo um hit forte sem repetir slash, cross, sparks ou shield-break.
...
- `preview/hit-ground-punch-preview-v2.gif`: preview em loop.
