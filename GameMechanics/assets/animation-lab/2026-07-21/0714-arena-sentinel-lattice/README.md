# Arena Sentinel Lattice — candidato de feedback de arena

Sinal de controle para o Bomba PvP. Um nó diamantado projeta quatro feixes diagonais, monta uma malha de cantos, fecha um perímetro octogonal, confirma a posse com um tick dourado e recolhe a energia.
...
- `preview/arena-sentinel-lattice-preview-v2.gif`: preview em loop, 60ms por frame.
