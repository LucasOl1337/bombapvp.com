# HUD Ability Ready Flare — candidato de animação curta de HUD

## Entrega

Animação de 16 frames para um slot de habilidade: badge angular cyan/azul com núcleo âmbar, estrela de prontidão, anel fino e chevrons orbitais. O pacote permanece como `Candidato` e não foi conectado ao runtime.
...
- `preview/hud-ability-ready-flare-preview-v2.gif` — preview em loop, 60ms por frame.
