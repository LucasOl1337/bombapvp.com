# Bomb Smoke — candidato de explosão

Rodada do laboratorio noturno do Bomba PvP na categoria de VFX de bomba/explosao. O efeito mostra uma nuvem de fumaça cinza-violeta com brasas laranja: cresce, perde densidade e se desfaz em fragmentos.
...
- `preview/bomb-smoke-preview-v2.gif`: preview com 16 frames a 60 ms por frame.
