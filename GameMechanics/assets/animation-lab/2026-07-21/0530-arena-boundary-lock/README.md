# Arena Boundary Lock — candidato de feedback de arena

## Entrega

Animação de 16 frames para feedback de limite: quatro cantos angulares fecham uma zona quadrada, travam com nós ciano, pulsam em lime e reabrem. O pacote permanece como `Candidato` e não foi conectado ao runtime.
...
- `preview/arena-boundary-lock-preview-v2.gif` — preview em loop, 60ms por frame.
