# Hit Armor Rattle — candidato de hit/impacto

Hit mecânico para o Bomba PvP: dois chevrons de aço comprimem uma placa âmbar, geram um flash ciano-branco, soltam pequenos ticks metálicos e retornam ao alinhamento. A leitura cobre contato e stagger sem repetir slash, sparks, shield break, ground punch, parry, recoil ou ricochet.
...
- `preview/hit-armor-rattle-preview-v2.gif`: preview de 16 frames a 60ms por frame.
