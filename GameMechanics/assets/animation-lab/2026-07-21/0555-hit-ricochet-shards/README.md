# Hit Ricochet Shards — candidato de hit/impacto

Impacto curto para o Bomba PvP: um núcleo diamante azul comprime, lança estilhaços ciano e âmbar em diagonais, produz um clarão central e retorna ao estado compacto. A leitura é direcional e complementar aos candidatos de slash, parry, shield break, ground punch e recoil burst.
...
- `preview/hit-ricochet-shards-preview-v2.gif`: preview de 16 frames a 60ms por frame.
