# Arena Lane Wayfinder — candidato de feedback de arena

Wayfinder de rotação para o Bomba PvP: um marcador triangular ciano recebe três aletas violetas em órbita, trava em um conjunto de chevrons, projeta uma seta âmbar curta e retorna ao estado ocioso. A silhueta direcional complementa os feedbacks de reticle, controle, beacon, captura, gate, boundary e ownership hex.
...
- `preview/arena-lane-wayfinder-preview-v2.gif`: preview de 16 frames a 60ms por frame.
