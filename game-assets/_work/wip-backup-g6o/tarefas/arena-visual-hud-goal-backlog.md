...
Seamless cobble + mean-matched baseAlt, continuous lanes, masonry charcoal walls, portal dashed rings (≠ spawn), crate + crateAlt checker, break FX, spawn rings only on pads. Live training screenshots green.
