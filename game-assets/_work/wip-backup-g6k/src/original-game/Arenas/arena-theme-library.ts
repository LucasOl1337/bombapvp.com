...
export const ARENA_THEME_LIBRARY: readonly ArenaThemeDefinition[] = [
  {
    ...
    pixellabDescription:
      "1). warm limestone floor tile, anonymous grain, seamless edges 2). brighter cream lane tile continuous (no sticker frame) 3). spawn tile with thin warm-gold open ring 4). charcoal stone wall slab soft dark rim + thin top lip only 5). top-down wood crate lid with iron cross-bands (orthographic, not isometric)",
    renderMode: "sprite",
    tilePaths: {
